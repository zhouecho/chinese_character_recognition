...
tf.app.flags.DEFINE_integer('max_steps', 36002, 'the max training steps ')
...
tf.app.flags.DEFINE_string('checkpoint_dir', './checkpoint_20180116/', 'the checkpoint dir')
...
def build_graph(top_k):
    ...
    with tf.device('/cpu:0'):
        with slim.arg_scope([slim.conv2d, slim.fully_connected],
            ...
            logits = slim.fully_connected(fc1, FLAGS.charset_size, activation_fn=None,
                                          scope='fc2')
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = '../data/test/03754/98106.png'
